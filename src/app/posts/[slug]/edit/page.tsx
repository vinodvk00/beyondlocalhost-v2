...
export default function EditPostForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Generate HTML from BlockNote content on client-side
            const contentHtml = await editor.blocksToFullHTML(content);

            // Prepare updated post data
            const postData = {
                title: title.trim(),
                content, // BlockNote JSON array
                contentHtml, // Pre-generated HTML
            ...
            console.log('Updating post with HTML length:', contentHtml.length);
